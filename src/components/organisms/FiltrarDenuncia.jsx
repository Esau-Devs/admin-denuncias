...
    
    const availableStates = ['pendiente', 'en proceso', 'resuelta']; 
...
                                className={`px-4 py-2 rounded-lg text-white font-semibold transition duration-200 whitespace-nowrap ${
                                    isSaving || currentStatus === denuncia.estado.toLowerCase() 
